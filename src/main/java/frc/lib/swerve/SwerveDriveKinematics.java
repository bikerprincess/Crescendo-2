...
public class SwerveDriveKinematics {
    ...
    public edu.wpi.first.math.kinematics.SwerveDriveKinematics asWpiSwerveDriveKinematics() {
        edu.wpi.first.math.geometry.Translation2d[] wpiTranslations = new edu.wpi.first.math.geometry.Translation2d[getNumModules()];
        for(int i = 0; i < getNumModules(); i++) {
            wpiTranslations[i] = getModuleLocations()[i].asWpiTranslation2d();
        }
        return new edu.wpi.first.math.kinematics.SwerveDriveKinematics(wpiTranslations);
    }
}
