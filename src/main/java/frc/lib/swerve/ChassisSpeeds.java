...
public class ChassisSpeeds {
    ...
    public ChassisSpeeds(edu.wpi.first.math.kinematics.ChassisSpeeds wpiChassisSpeeds) {
        this(wpiChassisSpeeds.vxMetersPerSecond, wpiChassisSpeeds.vyMetersPerSecond, wpiChassisSpeeds.omegaRadiansPerSecond);
    }
